defmodule PhoenixKitProjects.ActivityLogAssertions do
  @moduledoc """
  Helpers for asserting activity log entries landed with the right
  action, module, and metadata shape.

  Imported into `PhoenixKitProjects.DataCase` and
  `PhoenixKitProjects.LiveCase` so every DB-backed test can reach
  them.
  """
  ...
  def list_activities, do: query_activities([])
